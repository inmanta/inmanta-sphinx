    ...
    stage("stage"){
      steps{
        script{
          ...
          sh '$INMANTA_TEST_ENV/bin/python3 -m pip install -U -c inmanta/requirements.txt inmanta sphinx-argparse sphinx-autodoc-annotation sphinx-rtd-theme sphinxcontrib-serializinghtml'

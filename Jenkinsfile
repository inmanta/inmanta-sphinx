    ...
    stage("stage"){
      steps{
        script{
          ...
          sh 'rm -rf $INMANTA_TEST_ENV; python3 -m venv $INMANTA_TEST_ENV; $INMANTA_TEST_ENV/bin/python3 -m pip install -U -c inmanta/requirements.txt inmanta; $INMANTA_TEST_ENV/bin/python3 -m pip install -U .'
